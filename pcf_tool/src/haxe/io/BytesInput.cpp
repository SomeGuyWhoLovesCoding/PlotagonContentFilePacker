...
HX_LOCAL_STACK_FRAME(_hx_pos_a628d02b10887081_83_set_position,"haxe.io.BytesInput","set_position",0xafd318f5,"haxe.io.BytesInput.set_position","C:\\HaxeToolkit\\haxe\\std/haxe/io/BytesInput.hx",83,0xd7d0a806)
...
int BytesInput_obj::set_position(int p){
            	HX_STACKFRAME(&_hx_pos_a628d02b10887081_83_set_position)
HXLINE(  84)		if ((p < 0)) {
HXLINE(  85)			p = 0;
            		}
            		else {
